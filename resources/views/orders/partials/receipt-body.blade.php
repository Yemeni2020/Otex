        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 space-y-8">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-slate-600 mt-2">Paid on {{ \Carbon\Carbon::parse($placedAt)->toFormattedDateString() }}</p>
                </div>
            ...
            <div class="border border-slate-200 rounded-xl overflow-hidden">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-200 text-sm">
                        ...
                        @empty
                            <tr>
                                <td class="px-4 py-3 text-slate-600" colspan="4">No items found for this receipt.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
