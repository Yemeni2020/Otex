                        ...
                        <div class="space-y-4" id="paymentCardContainer">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border border-slate-200 rounded-xl p-4 bg-slate-50">
                                <div class="flex items-center gap-4">
                                    <div class="shrink-0">
                                        <svg id="cardBrandIcon" viewBox="0 0 36 24" aria-hidden="true" class="w-14 h-9 rounded-md shadow-sm">
...
(() => {
    ...
    const brands = [
        { name: 'Visa', regex: /^4/, color: '#224DBA' },
        { name: 'Mastercard', regex: /^(5[1-5]|2[2-7])/, color: '#EB001B' },
        { name: 'Amex', regex: /^3[47]/, color: '#016FD0' },
        { name: 'Discover', regex: /^6(?:011|5)/, color: '#FF6000' },
    ];
