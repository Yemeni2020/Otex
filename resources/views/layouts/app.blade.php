...
<body class="bg-gray-100 text-gray-900 min-h-screen expansion-alids-init">
    ...
    <!-- Scroll to top -->
    <button id="scrollToTop" id="scrollToTopPath" aria-label="Scroll to top" class="scroll-to-top fixed bottom-6 right-4 z-35 hidden sm:block transition-opacity duration-300 opacity-0" type="button">
