        ...
        <div class="bg-slate-900/95 text-slate-300 text-xs py-1.5 hidden md:block backdrop-blur-sm">
            <div class="container mx-auto px-4 flex justify-between items-center">
                <p class="flex items-center gap-1">
                    ...
                    <span>Ship to: <span class="text-white font-medium">New York, US</span></span>
                </p>
                <div class="flex gap-4">
                    <span class="hover:text-white cursor-pointer transition-colors">Track Order</span>
                    <span class="hover:text-white cursor-pointer transition-colors">Support</span>
                    <span class="text-blue-400 font-medium">Free Shipping on orders over $100</span>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between gap-4 lg:gap-8">
                ...
                <nav class="hidden lg:flex items-center gap-8 text-sm font-medium text-slate-700">
                    <a class="hover:text-blue-600 transition-colors relative group py-2" href="/">Home
                    ...
                    <a class="hover:text-blue-600 transition-colors relative group py-2 text-blue-600" href="/about">About Us
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    ...
                    <!-- Cart -->
                    <button class="inline-flex items-center justify-center text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 w-10 relative bg-slate-900/90 hover:bg-blue-600 text-white rounded-full transition-all duration-300 shadow-lg hover:shadow-blue-500/30 backdrop-blur-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5">
