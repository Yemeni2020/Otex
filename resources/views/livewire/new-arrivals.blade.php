        ...
        <section class="relative mt-6">
            ...
            <div id="newArrivalsViewport"
                ...
                @foreach($this->visibleProducts as $product)
                    <div class="snap-start shrink-0 w-[220px] sm:w-[240px] md:w-[260px] bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl h-full flex flex-col relative group" wire:key="new-arrival-{{ $product['id'] }}">
