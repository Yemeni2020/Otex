    ...
    <main class="py-12">
        <div class="mx-auto max-w-6xl px-4">
            ...
            <div class="mb-8 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative grid h-12 w-12 place-items-center rounded-lg border border-slate-200 bg-white">
                        <!-- wallet icon -->
                        <svg viewBox="0 0 24 24" class="h-6 w-6 text-slate-700" fill="none" stroke="currentColor" stroke-width="1.6">
                        <path d="M3 7.5A3.5 3.5 0 0 1 6.5 4h11A3.5 3.5 0 0 1 21 7.5V18a2 2 0 0 1-2 2H6.5A3.5 3.5 0 0 1 3 16.5V7.5z"/>
                ...
                <div class="flex items-center gap-3">
                    <div class="relative grid h-12 w-12 place-items-center rounded-lg bg-blue-800 text-white ">
                        ...
                        <span class="absolute -right-2 -top-2 grid h-5 w-5 place-items-center rounded-full bg-white text-xs font-bold text-red-400 shadow">2</span>
                    </div>
                    <div class="text-right">
            ...
            <section class="rounded-[18px] bg-white p-6">
                {{-- desktop table head --}}
                <div class="hidden rounded-[14px] bg-white px-6 py-4 text-sm text-slate-500 md:flex md:items-center md:justify-between">
                ...
                <article class="mt-6 rounded-[14px] bg-white px-5 py-5 shadow-sm md:px-6">
                    ...
                    <div class="flex items-center gap-4">
                        {{-- products --}}
                        <div class="flex items-center gap-4">
                            <button class="grid h-8 w-8 place-items-center rounded-full bg-red-500/90 text-white" aria-label="delete">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                </svg>
                            </button>
                            <div class="flex items-center gap-3">
                                <div class="grid h-12 w-12 place-items-center rounded-full border border-slate-200 bg-white overflow-hidden">
                                    <img src="https://images.unsplash.com/photo-1581235720704-06d3acfcb36f?w=800&q=80" alt="product" srcset="https://images.unsplash.com/photo-1581235720704-06d3acfcb36f?w=800&q=80" class="h-full w-full object-cover">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="hidden md:flex md:items-center md:gap-16">
                        <div class="text-sm font-semibold text-slate-700">56.35 <span class="text-slate-400">$</span></div>
                        ...
                        <div class="w-14 text-left text-sm font-bold text-slate-800">65.35 <span class="text-slate-400">$</span></div>
                    </div>
                    {{-- Mobile values --}}
                ...
                {{-- CTA --}}
                <div class="mt-6">
                    <x-button-link  href="{{ route('checkout') }}" variant="solid" class="w-full rounded-full bg-blue-500 py-4 mt-4 text-white text-center text-sm font-extrabold shadow-sm hover:brightness-95">
                        Complete the order
                    </x-button-link>
                </div>
            </section>
