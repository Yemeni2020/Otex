        ...
        <div class="min-h-screen bg-slate-50">
            <section class="bg-slate-900 text-white py-24 relative overflow-hidden">
                ...
                <div class="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <p class="text-xl text-slate-300 max-w-2xl mx-auto">Otex is premier destination for automotive enthusiasts who demand quality, performance, and style.</p>
                </div>
            </section>
            ...
            <section class="py-20 container mx-auto px-4">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p class="text-slate-600 leading-relaxed mb-6">Founded in 2023, Otex started with a simple idea: car accessories should be as high-quality as the vehicles they go into. We were tired of cheap, ill-fitting parts that didn't last.</p>
                        ...
                        @foreach ([['name'=>'John Doe','role'=>'Product Specialist'],['name'=>'John Doe','role'=>'Product Specialist'],['name'=>'John Doe','role'=>'Product Specialist']] as $member)
                            <div class="group">
                                <div class="w-48 h-48 mx-auto bg-slate-200 rounded-full mb-6 overflow-hidden">
                                    <img alt="Portrait of a smiling team member in a professional setting" class="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" src="https://images.unsplash.com/photo-1635185481431-661b09594e6c">
                                </div>
