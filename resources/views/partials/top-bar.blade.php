...
<div id="siteTopbar" class="block bg-white border-b border-gray-200 topbar-transition" style="position: fixed; top: 0; left: 0; right: 0; z-index: 60;">
    <div class="w-full">
    <div class="mx-auto flex max-w-6xl items-center gap-4 px-4 py-3">

      <!-- Label -->
      <span class="shrink-0 rounded-full bg-black px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white">
        Breaking
      </span>
